                        ...
                        <div class="modal-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4" v-if="form.device_type_id == 1 || form.device_type_id == 2">
                                    ...
                                    <input class="form-control" v-model="form.ip_address" type="text" autocomplete="off" required>
                                    <small class="text-danger" v-if="errors.ip_address">@{{errors.ip_address[0]}}</small>
                                </div>
                                <div class="col-md-4" v-if="form.device_type_id == 1 || form.device_type_id == 2">
                                    <label class="form-label">Subnet Mask</label>
                                    <input class="form-control" v-model="form.subnet_mask" type="text" autocomplete="off" required>
                                    <small class="text-danger" v-if="errors.subnet_mask">@{{errors.subnet_mask[0]}}</small>
                                </div>
                                <div class="col-md-4" v-if="form.device_type_id == 1 || form.device_type_id == 2">
                                    <label class="form-label">Standard Gateway</label>
                                    <input class="form-control" v-model="form.gateway" type="text" autocomplete="off" required>
                                ...
                                <div class="col-md-4" v-if="form.device_type_id == 1 || form.device_type_id == 2">
                                    ...
                                    <input class="form-control" v-model="form.dns_achtervoegesl" type="text" autocomplete="off" required>
                                    <small class="text-danger" v-if="errors.dns_achtervoegesl">@{{errors.dns_achtervoegesl[0]}}</small>
                                </div>
                                <div class="col-md-4" v-if="form.device_type_id == 3 || form.device_type_id == 4">
                                    <label class="form-label">Desk</label>
                                    <input class="form-control" v-model="form.desk" type="text" autocomplete="off" required>
                                    <small class="text-danger" v-if="errors.desk">@{{errors.desk[0]}}</small>
                                </div>
                                <div class="col-md-4" v-if="form.device_type_id == 3 || form.device_type_id == 4">
                                    <label class="form-label">Terminal Model</label>
                                    <input class="form-control" v-model="form.terminal_model" type="text" autocomplete="off" required>
                                    <small class="text-danger" v-if="errors.terminal_model">@{{errors.terminal_model[0]}}</small>
                                </div>
                                <div class="col-md-4" v-if="form.device_type_id == 3 || form.device_type_id == 4">
                                    <label class="form-label">Serial Number</label>
                                    <input class="form-control" v-model="form.serial_number" type="text" autocomplete="off" required>
                                ...
                                <div class="col-md-4" v-if="form.device_type_id == 3 || form.device_type_id == 4">
                                    ...
                                    <input class="form-control" v-model="form.software_version" type="text" autocomplete="off" required>
                                    <small class="text-danger" v-if="errors.software_version">@{{errors.software_version[0]}}</small>
                                </div>
                                <div class="col-md-4" v-if="form.device_type_id == 3 || form.device_type_id == 4">
                                    <label class="form-label">SIM Card</label>
                                    <select class="form-control" v-model="form.sim_card" id="type">
                                ...
                                <div class="col-md-4" v-if="form.device_type_id == 3 || form.device_type_id == 4">
                                    ...
                                    <input class="form-control" v-model="form.sim_serial_number" type="text" autocomplete="off" required>
                    ...
                    <div class="modal-body">
                        ...
                        <table class="table table-sm table-striped table-bordered">
                            ...
                            <tr v-if="details.device_type_id == 3 || details.device_type_id == 4">
                                <td><i class="fa fa-tag"></i> <strong>Desk : </strong></td>
                                <td>@{{ details.desk }}</td>
                            </tr>
                            <tr v-if="details.device_type_id == 3 || details.device_type_id == 4">
                            ...
                            <tr v-if="details.device_type_id == 3 || details.device_type_id == 4">
                                <td><i class="fa fa-calendar"></i> <strong>Software Version : </strong></td>
                                <td>@{{ details.software_version }}</td>
                            </tr>
                            <tr v-if="details.device_type_id == 3 || details.device_type_id == 4">
