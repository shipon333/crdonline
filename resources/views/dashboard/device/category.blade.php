@extends ('layouts.app')
@section('title','Category Wise Device List')
@section('content')
                                ...
                                <div class="row">
                                    <div class="col-sm-2 col-md-6">
                                        <div class="device-title">
                                            <h5>
                                                <i class="fa fa-laptop"></i> Device List of -
                                                <span class="text-warning"> {{ $type->name }}</span>
                                            </h5>
        ...
        Vue.createApp({
            ...
            methods:{
                ...
                getDevices(){
                    ...
                    axios.get('/device-list-by-type/'+"{{ $type->id }}",{params:request})
